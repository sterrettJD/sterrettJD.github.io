...
Professionally, this manifests through using computational methods to study the **ecology of the gut microbiome** and how **psychological stress interacts with physiology**. I build tools to process and statistically model high-dimensional "-omics" data, with a focus on the **gut-brain axis**. Generally, I identify as an ecophysiologist existing at the intersection of ecology, genetics, neuroscience, and stress physiology, and I find myself working as a software developer, bioinformatician, and statistician.
